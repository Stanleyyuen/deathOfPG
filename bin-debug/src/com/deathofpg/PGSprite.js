...
(function (game) {
    var PGSprite = (function (_super) {
        ...
        var __egretProto__ = PGSprite.prototype;
        ...
        // {
        //     var _this: PGSprite = (< game.PGSprite > e.target);
        ...
        // }
        __egretProto__.onHpChange = function (e) {
    ...
    PGSprite.prototype.__class__ = "game.PGSprite";
})(game || (game = {}));
