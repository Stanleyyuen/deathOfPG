...
(function (game) {
    var PGScene = (function () {
        ...
        var __egretProto__ = PGScene.prototype;
        ...
        //传入场景的字符串
        __egretProto__.OnLoad = function () {
            this.OnRelease();
        ...
        //建立一个血量挂件
        __egretProto__.creatDecration = function () {
        ...
        //建立PG
        __egretProto__.createPG = function () {
            var pg;
    ...
    PGScene.prototype.__class__ = "game.PGScene";
})(game || (game = {}));
